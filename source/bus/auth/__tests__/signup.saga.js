...
const saga = cloneableGenerator(workers.signup)(signupAction);
let clone = null;
...
describe("signup saga:", () => {
  ...
  describe("should handle a 400 status response", () => {
    test("a fetch requestj should return 400 status response", () => {
  ...
  describe("should handle a 200 status response", () => {
    test("a fetch requestj should return 200 status response", () => {
